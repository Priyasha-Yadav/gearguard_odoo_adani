  ...
  const fetchRecentActivities = async () => {
    try {
      ...
      const activities = requests.map(request => ({
        id: request._id,
        type: request.stage === 'New' ? 'created' : 
              request.stage === 'In Progress' ? 'started' : 
              request.stage === 'Repaired' ? 'completed' : 'updated',
            ...
            {recentActivities.length === 0 ? (
              <div className="flex items-center p-4 bg-gray-50 rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">Start creating maintenance requests</p>
                </div>
              </div>
            ) : (
              recentActivities.map((activity) => {
                ...
                const getActivityColor = (type) => {
                  switch (type) {
                    ...
                    case 'started': return 'bg-orange-100 text-orange-600';
                  ...
                  <div key={activity.id} className="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">
                        Request {activity.type}: {activity.subject}
                      </p>
